...
async function generateEmailAndExcel(data) {
...
Package Price: €${toTwoDecimals(data.trip_total_margin.golfer_margin_sharing)} per person sharing / €${toTwoDecimals(data.trip_total_margin.golfer_margin_single)} Single
...
module.exports = { generateEmailAndExcel };
